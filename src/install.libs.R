...
#R_builds <- gsub( "/inst/", "/build/", R_files)
#r_builds <- gsub( "/inst/", "/build/", r_files)
#py_builds <- gsub( "/inst/", "/build/", py_files)
#sh_builds <- gsub( "/inst/", "/build/", sh_files)
...
cat(sprintf("#  %s   \n", bin_dest))
cat(sprintf("#  To use SWAN, add above path to your PATH evironment \n"))
cat(sprintf("#                                   \n"))
cat(sprintf("#####################################\n"))
